...
# The EVALUATE function also needs to be changed to operate on a list of individuals, rather than a single individual, because the multiprocessing.Pool().map() function applies the EVALUATE function to each individual in the list of individuals (population).
#
